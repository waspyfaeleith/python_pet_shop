...
class TestPetShop(unittest.TestCase):
    ...
    def test_pets_sold(self):
        sold = pets_sold(self.cc_pet_shop)
    ...
    def test_stock_count(self):
        count = stock_count(self.cc_pet_shop)
        self.assertEqual(6, count)

    def test_all_pets_by_breed__found(self):
        pets = pets_by_breed(self.cc_pet_shop, "British Shorthair")
        self.assertEqual(2, len(pets))

    def test_all_pets_by_breed__not_found(self):
        pets = pets_by_breed(self.cc_pet_shop, "Dalmation")
    ...
    def test_customer_cash(self):
        cash = customer_cash(self.customers[0])
    ...
    def test_add_pet_to_customer(self):
        ...
        self.assertEqual(1, customer_pet_count(customer))
    ...
    def test_sell_pet_to_customer__pet_found(self):
        ...
        self.assertEqual(1, customer_pet_count(customer))
        self.assertEqual(1, pets_sold(self.cc_pet_shop))
        self.assertEqual(100, customer_cash(customer))
        self.assertEqual(1900, total_cash(self.cc_pet_shop))
    ...
    def test_sell_pet_to_customer__pet_not_found(self):
        ...
        self.assertEqual(0, customer_pet_count(customer))
        self.assertEqual(0, pets_sold(self.cc_pet_shop))
        self.assertEqual(1000, customer_cash(customer))
        self.assertEqual(1000, total_cash(self.cc_pet_shop))
    ...
    def test_sell_pet_to_customer__insufficient_funds(self):
        ...
        self.assertEqual(0, customer_pet_count(customer))
        self.assertEqual(0, pets_sold(self.cc_pet_shop))
        self.assertEqual(50, customer_cash(customer))
        self.assertEqual(1000, total_cash(self.cc_pet_shop))
